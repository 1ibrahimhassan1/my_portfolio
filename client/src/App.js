    ...
    return (
      <div>
        <nav className='navbar navbar-expand-sm navbar-dark bg-dark' style={{position:"fixed", width:"100%", zIndex: 1}}>
            <button onClick={this.focusMe} data-toggle="collapse" data-target=".navbar-collapse.show" className="navbar-brand">Ibrahim Hassan</button>
            ...
            <div className="collapse navbar-collapse" id="navbarMenu">
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item">
                        <button onClick={this.focusProject} data-toggle="collapse" data-target=".navbar-collapse.show" className="nav-link">Projects</button>
                    </li>
                    <li className="nav-item">
                        <button onClick={this.focusAbout} data-toggle="collapse" data-target=".navbar-collapse.show" className="nav-link">About</button>
                    </li>
                </ul>
            </div>
        </nav>
