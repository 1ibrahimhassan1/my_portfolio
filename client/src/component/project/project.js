    ...
    render() {
        ...
        return (
            <div className="container-fluid main-font" style={topDiv}>
                ...
                <h1 style={{paddingTop: "6px"}} id='project'>My Projects</h1>(Table entries are either live demos or links to repos)
                ...
                <table className="table table-hover">
                    ...
                    <tbody onClick={this.toGithub}>
                        ...
                        <tr>
                            <td url='https://expo.io/artifacts/aacd6f03-16f8-46ad-b24c-3678395ff85c'>Cash Counting App</td>
                            <td url='https://expo.io/artifacts/aacd6f03-16f8-46ad-b24c-3678395ff85c'>(Made in React-Native and only compiled to run on android devices for the time being). 
                            Made to make closing the cash at my part-job alot faster and alot less error-prone. The meat of my time
                            developing this app involved splitting the values between what was sent to accounting and what was
                            kept in the till for the next day while also recording the amounts that added up to the totals.</td>
                        </tr>
                    </tbody>
                </table>    
